...
class LeaveApplicaton extends StatefulWidget {
  @override
  _LeaveApplicatonState createState() => _LeaveApplicatonState();
}

class _LeaveApplicatonState extends State<LeaveApplicaton> {

  final GlobalKey<FormState> _formkey = GlobalKey<FormState>();
  DateTime _current = DateTime.now();
  String _datefrom=" ";
  String _dateto=" ";
  String _issue, _explain;
